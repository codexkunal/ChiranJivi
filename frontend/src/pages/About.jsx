    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="text-center mb-20">
        <h1 className="text-5xl font-bold mb-6">
          About <span className="text-blue-600">ChiranJivi</span>
        </h1>
      ...
      <div className="flex flex-col lg:flex-row gap-16 mb-20 items-center">
        ...
        <div className="lg:w-1/2 space-y-8">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            At ChiranJivi, we're revolutionizing the way you access healthcare services. Our platform combines cutting-edge technology with compassionate care to provide you with an unparalleled medical appointment experience.
          </p>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-white p-8 rounded-2xl border-l-4 border-blue-600">
            ...
            <p className="text-gray-600 leading-relaxed">
              Our vision at ChiranJivi is to create a seamless healthcare experience for every user. We aim to bridge the gap between patients and healthcare providers, making it easier for you to access the care you need, when you need it.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mb-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-6">
            Why Choose <span className="text-blue-600">ChiranJivi</span>
          </h2>
